...
* Creating static controller to handle index on 'static' pages
* Creating static page parts controller to handle content of 'static' pages
* Need to decide on a better name than 'static pages'
...
* Replacing original CSS with twitter's bootstrap
